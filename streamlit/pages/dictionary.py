LIST_SAMPLES_MSD = {
    ...
    "twocolor_degron_all_lines_30s_absolute_msd": "https://drive.google.com/uc?export=download&id=1FmwaxBTLt81s7HnZIqMJUjSRWR6fOaQO",
...
PAGES = {
    ...
    "Directionality analysis": "direction",
    "Two color imaging analysis": "pairwise_analysis",
}
...
SYSTEMATIC_ERRORS = {
    ...
    "rousetime": 0.0025,
    "twocolor_degron_all_lines_10s": 0.0104,
    "twocolor_degron_all_lines_10s_absolute_msd": 0.0148,
    "twocolor_degron_all_lines_30s_absolute_msd": 0.0148,
    "twocolor_degron_all_lines_30s": 0.0104,
    "twocolor_degron_twoctcf_2d_1s": 0.0104,
    "twocolor_degron_twoctcf_60s": 0.0104,
}
